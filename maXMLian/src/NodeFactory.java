...
class NodeFactory
{
	...
	private Comment createComment(javax.xml.stream.events.Comment event) {
		// TODO: Later we might reuse instances of the current depth in order to reduce the number of instantiations
	...
	private ProcessingInstruction createProcessingInstruction(javax.xml.stream.events.ProcessingInstruction processingInstruction) {
		// TODO: Later we might reuse instances of the current depth in order to reduce the number of instantiations
